...
def setupBeach():
    ...
    return beachBgImgs, beachConfirmButtonRect, beachConfirmButtonImg, beachExitRect, addButtonRect, trashButtonRect, trashImgs, addBg, posOffset, rotateImg, scaleImg, rotateRect, scaleRect, flipImg, flipRect
...
def setup():
    ...
    # beach stuff
    beachBgImgs, beachConfirmButtonRect, beachConfirmButtonImg, beachExitRect, addButtonRect, trashButtonRect, trashImgs, addBg, posOffset, rotateImg, scaleImg, rotateRect, scaleRect, flipImg, flipRect = setupBeach()
    ...
    return size, gap, cellW, hp, offset, acceleration, down, solveDown, colors, solveNext,\
        ...
        beachExitRect, addButtonRect, trashButtonRect, trashImgs,\
