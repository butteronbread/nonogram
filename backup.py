...
class Button():
    ...
    def get_pressed(self):
        ...
        return self.get_hover() and pygame.mouse.get_pressed()[0]
    ...
    while True:
        ...
        if stage == "home": # home page
            ...
            if rotating:
                ...
                try:
                    center = beachItemRects[selecting].center
                    mouse = pygame.mouse.get_pos()

                    diff = (mouse[0] - center[0], mouse[1] - center[1])
                    current_angle = int(math.atan2(diff[1], diff[0]) * 180 / math.pi)

                    if not down:
                        startMouseAngle = current_angle
                        ogRotation = beachData[selecting][1][3]

                    rotation_dir = 1 if beachData[selecting][1][4] else -1

                    angle_change = current_angle - startMouseAngle
                    beachData[selecting][1][3] = (ogRotation + angle_change * rotation_dir) % 360
