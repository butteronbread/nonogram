        ...
        if stage.split()[0] == "beach":
            ...
            if selecting != -1:
                ...
                if scaleRect.collidepoint(pygame.mouse.get_pos()) and pygame.mouse.get_pressed()[0]:
                    if not down:
                        ogPos = pygame.mouse.get_pos()
                    else:
                        beachData[selecting][1][2] += math.sqrt(((pygame.mouse.get_pos()[0]-ogPos[0])**2 + (pygame.mouse.get_pos()[1]-ogPos[1])**2)) * w
