...
def setupHome():
    ...
    ogSoundImgs = [pygame.image.load("imgs/on.png"), pygame.image.load("imgs/off.png")]
    soundImgs = [pygame.transform.scale(ogSoundImgs[0], (w*0.08, w*0.08)), pygame.transform.scale(ogSoundImgs[1], (w*0.08, w*0.08))]
    soundOn = False
...
def setup():
    ...
    return size, gap, cellW, hp, offset, acceleration, down, solveDown, colors, solveNext,\
        ...
        selecting, clickBg,\
        rotateImg, scaleImg, rotateRect, scaleRect,\
